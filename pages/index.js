  ...
  return (
    <>
      ...
      <div className="w-full">
        <Head>
          <title>Yabatech ECommerce</title>
          <meta name="description" content="Yabatech ECommerce Next provides a way to quickly get up and running with a fully configurable ECommerce site using Next.js." />
          <meta property="og:title" content="Yabatech ECommerce" key="title" />
        </Head>
        ...
        flex lg:flex-row flex-col">
          <div className="pt-4 pl-2 sm:pt-12 sm:pl-12 flex flex-col">
            ...
            />
            <Footer
              designer="Yabatech Project Group Members"
            />
          </div>

  ...
  return (
    <>
      <div className="w-full">
        <CartLink />
        <Head>
          <title>Yabatech ECommerce - All Categories</title>
          <meta name="description" content={`Yabatech ECommerce - All categories`} />
          <meta property="og:title" content="Yabatech ECommerce - All Categories" key="title" />
        </Head>
        <div className="
          pt-4 sm:pt-10 pb-8
        ">
